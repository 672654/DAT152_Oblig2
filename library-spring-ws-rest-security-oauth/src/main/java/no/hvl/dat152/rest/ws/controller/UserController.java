...
public class UserController {
  ...
  @PreAuthorize("hasRole('ADMIN') or (hasRole('USER') and authentication.details.getUserid() == #id)")
  ...
  @PreAuthorize("hasRole('ADMIN') or (hasRole('USER') and authentication.details.getUserid() == #userid)")
